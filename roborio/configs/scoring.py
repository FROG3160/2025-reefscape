...
L2_shoot = ScoringConfigs(0, 0.12, 0.12, 0, 12, "L2 Shoot", "Coral")
L3_shootV1 = ScoringConfigs(3, 0.2, 0.2, 2, 12, "L3V1 Shoot", "Coral")
L3_shootV2 = ScoringConfigs(5, 0.12, 0.12, 0, 12, "L3V2 Shoot", "Coral")
L3_dunk = ScoringConfigs(8, 0.08, -0.06, 0, 0, "L3 Dunk", "Coral")
L4_dunk = ScoringConfigs(13, 0.2, -0.03, 2, 0, "L4 Dunk", "Coral")
L4_shoot = ScoringConfigs(13, 0.22, 0.22, 3, 12, "L4 Shoot", "Coral")
